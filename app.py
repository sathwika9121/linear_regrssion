...
# --- Step 1: Data Loading ---
try:
    # This looks for the file directly in your GitHub repository
    ...
    try:
        ...
        st.error("⚠️ Missing 'model.pkl'. Ensure you have uploaded your trained model file to GitHub.")

except FileNotFoundError:
    st.error("⚠️ Missing 'calories_data.csv'. Ensure the CSV file is uploaded to your GitHub repository.")